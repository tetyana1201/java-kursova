...
const InputAndOutputPlusTheory = () => {
    ...
    useEffect(() => {
        const fetchSavedTheory = async () => {
            try {
                const querySnapshot = await getDocs(collection(db, '/thinputandoutput'));
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const docRef = await addDoc(collection(db, '/thinputandoutput'), {
                title,
                content,
                createdAt: new Date(),
            });
    ...
    const handleEdit = async () => {
        try {
            const theoryRef = doc(db, '/thinputandoutput', savedTheory.id);
...
export default InputAndOutputPlusTheory;