...
const ExStatemetnsBlockPract = () => {
    ...
    useEffect(() => {
        const questionsRef = ref(database, 'exstatemetnsblock');
    ...
    const finishTest = () => {
        ...
        if (userId && testResults.length > 0) {
            ...
            const resultsRef = ref(database, 'testResultsexstatemetnsblock/' + userId);
            set(resultsRef, {
                percentage,
                results: testResults,
            });
...
export default ExStatemetnsBlockPract;
