...
const OperatorsPlusTheory = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const docRef = await addDoc(collection(db, '/thoperators'), {
                title,
                content,
                createdAt: new Date(),
            });
    ...
    const handleEdit = async () => {
        try {
            const theoryRef = doc(db, '/thoperators', savedTheory.id);
    ...
    return (
        <div style={{width: '100%', height: '100%', position: 'relative', background: '#F4F2F6'}}>
            <div style={{width: 1440, height: 4434, position: 'absolute', left: 0, top: 94}}>
                <div style={{width: 1440, height: 4500, background: '#F4F2F6'}}/>
                ...
                <div style={{width: 1440, height: 397, background: 'white', position: 'absolute', left: 0, top: 4600}}/>
                <div style={{
                    color: '#150E06',
                    fontSize: 16,
                    fontFamily: 'Raleway',
            ...
            <div style={{width: '100%', height: '100%', position: 'relative', top: 4600}}>
                <Link to="/about" style={{
                    position: 'absolute',
                    left: 745,
                    top: 45,
...
export default OperatorsPlusTheory;