    ...
    return (
        <div style={{ width: '100%', height: '100%', position: 'relative', background: '#F4F2F6' }}>
            <div style={{ width: 1440, height: 934, position: 'absolute', left: 0, top: 94 }}>
                <div style={{ width: 1440, height: 2870, background: '#F4F2F6' }} />
                <div style={{ width: 580, height: 393, position: 'absolute', left: 92, top: 217 }}>
                </div>
                <div style={{ marginLeft: '5cm', marginRight: '5cm', marginTop: '780px', position: 'relative', zIndex: 10 }}>
                    {theories.slice(0, 1).map(theory => (
                        <div key={theory.id} style={{ position: 'relative', marginTop: '-3575px' }}>
                            <h3 style={{ fontSize: '55px', textAlign: 'left', marginLeft: '265px' }}>{theory.title}</h3>
                            <div
                ...
                <div style={{ width: 1440, height: 385, background: 'white', position: 'absolute', left: 0, top: 2960 }} />
                <div style={{
                    color: '#150E06',
                    fontSize: 16,
                    fontFamily: 'Raleway',
            ...
            <div style={{ width: '100%', height: '100%', position: 'relative', top: 2970 }}>
                <Link to="/about" style={{
                    position: 'absolute',
                    left: 745,
                    top: 45,
...
export default PrimitiveTheory;
